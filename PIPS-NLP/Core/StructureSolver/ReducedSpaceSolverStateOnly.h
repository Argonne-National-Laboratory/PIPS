...
#ifndef NLPREDUSEDSOLCERSP_NLP
#define NLPREDUSEDSOLCERSP_NLP
...
class ReducedSpaceSolverStateOnly: public DoubleLinearSolver{
...
//	int localNegaEigVal;
  ...
  public: 
	...
	ReducedSpaceSolverStateOnly(DoubleMatrix* MatIn, 
