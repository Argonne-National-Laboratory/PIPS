...
protected:
  ...
  qpHashTable *rowTable;

  /** has table containing column names */
  qpHashTable *colTable;
...
public:
   ...
   *  in a file.
   *  @param _filename the name of the file to read. If _filename == '-'
   ...
   */
  static MpsReader * newReadingFile( char _filename[], int& iErr );
