...
parameter g(j) obj coefficients / j1 2, j2 2, j3 2, j4 2, j5 2, j6 2, j7 2, j8 0 /
          b(i) right hand side  / i1 3, i2 10, i3 3, i4 6, i5 4, i6 7 /
...
$ echo jacobian exampleAC_singletonColumn.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
