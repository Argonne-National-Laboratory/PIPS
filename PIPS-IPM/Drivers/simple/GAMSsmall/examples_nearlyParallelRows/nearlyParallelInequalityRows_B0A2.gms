* ./gamsexample.sh -NP=3 -BLOCKS=4 -GAMSFILE=nearlyParallelInequalityRows_B0A2 -PRESOLVE=true

Set i rows    / i1*i18 /
* subset of linking rows
    j columns / j1*j18 /;

parameter g(j) obj coefficients / j1 1, j2 1, j3 -1, j4 -5, j5 1, j6 1, j7 1, j8 1, j9 1, j10 1, j11 1, j12 1, j13 1,
            j14 1, j15 1, j16 1, j17 1, j18 1 /
          bA(i) right hand side  / i1 0, i2 1, i3 0, i4 -2, i5 0, i6 0, i7 -2, i8 0, i9 1, i10 0, i11 -2,
            i12 0, i13 -3, i14 1, i15 -3, i16 -4, i17 -4, i18 -2 /
          cupp(i) c right hand side   / i1 -2, i2 -1, i3 100, i4 100, i5 100, i6 100, i7 100, i8 10, i9 10, i10 20, i11 0.8,
           i12 100, i13 100, i14 100, i15 100, i16 100 /
...
i18                                1     1                 1                                   1
;
*    ?     ?     ?     ?   19.5    1    -2    -2     1    -2    -2     0     1    -2    -2     1    -2    -2
...
$ echo jacobian nearlyParallelInequalityRows_B0A2.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
