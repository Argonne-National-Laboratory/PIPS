* ./gamsexample.sh -NP=3 -BLOCKS=4 -GAMSFILE=nearlyParallelEqualityAndInequalityRows_B0A2 -PRESOLVE=true
...
parameter g(j) obj coefficients / j1 1, j2 1, j3 1, j4 -1, j5 1, j6 1, j7 1, j8 1, j9 1, j10 1, j11 1, j12 1, j13 1 /
          bA(i) right hand side  / i1 0, i2 3, i3 0, i4 -2, i5 0, i6 0, i7 -2, i8 0, i9 5, i10 0, i11 0,
            i12 0, i13 -3, i14 1, i15 1, i16 -4, i17 -4, i18 -2 /
...
i18                                1     1                 1                                   1
;
*   -2     ?   0.4     2   19.5    1    -2    -2     1    -2    -2     0     1    -2    -2     1    -2    -2
...
Variables          x(j) / j1.up 2, j2.lo -1, j2.up 1, j3.lo -1, j12.lo 0, j12.up 30, j5.lo 19.5, j5.up 22 /
...
$ echo jacobian nearlyParallelEqualityAndInequalityRows_B0A2.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
