* ./gamsexample.sh -NP=3 -BLOCKS=4 -GAMSFILE=nearlyParallelEqualityRowsOneRowNoSingleton_B0A2 -PRESOLVE=true

Set i rows    / i1*i18 /
* subset of linking rows
    j columns / j1*j18 /;

parameter g(j) obj coefficients / j1 0, j2 1, j3 1, j4 -1, j5 1, j6 1, j7 1, j8 1, j9 1, j10 1, j11 1, j12 -0.05, j13 1 /
          bA(i) right hand side  / i1 -2, i2 1, i3 0, i4 -2, i5 0, i6 0, i7 -2, i8 0, i9 1, i10 -10, i11 -5,
...
i18                                1     1                 1                                   1
;
*    0     ?     ?    -3   19.5    1    -2    -2     1    -2    -2   -20     1    -2    -2     1    -2    -2
...
Variables          x(j) / j1.lo -10, j1.up 5, j2.lo 1, j2.up 1, j3.lo -1, j3.up -1, j12.lo -30, j12.up 30, j5.lo 19.5, j5.up 22 /
...
$ echo jacobian nearlyParallelEqualityRowsOneRowNoSingleton_B0A2.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
