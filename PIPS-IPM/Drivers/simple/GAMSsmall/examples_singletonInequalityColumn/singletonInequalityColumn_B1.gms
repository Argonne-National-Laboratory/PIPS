...
parameter g(j) obj coefficients / j1 1, j2 1, j3 1, j4 0, j5 1, j6 1, j7 1, j8 1, j9 1, j10 1, j11 1, j12 1, j13 1, j14 1 /
...
*          clow(i) c left hand side    / i1 0, i2 1, i3 -1, i4 -100, i5 -100, i6 -100, i7 -100, i8 -100, i9 -100, i10 -100, i11 -100, i12 -100, i13 -100, i14 -100, i15 -100 /
          cupp(i) c right hand side   / i1 100, i2 100, i3 100, i4 -1, i5 -1, i6 100, i7 100, i8 100, i9 100, i10 100, i11 100, i12 100, i13 100, i14 100, i15 100 /
...
i14   1     1                             1
;       
*     1    -2    -2     2   -20     1    -2    -2    1    -2    -2     1    -2    -2
* expected values for x full determined by Ax=b

* the singletonInequalityRow i4:
...
* we also have a fixing to do i5:
...
$ echo jacobian singletonInequalityColumn_B1.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
