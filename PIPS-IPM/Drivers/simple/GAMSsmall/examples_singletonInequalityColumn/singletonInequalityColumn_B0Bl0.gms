* ./gamsexample.sh -NP=3 -BLOCKS=4 -GAMSFILE=./singletonInequalityColumn_B0Bl0 -PRESOLVE=true
...
parameter g(j) obj coefficients / j1 0, j2 1, j3 0, j4 1, j5 1, j6 1, j7 1, j8 1, j9 1, j10 1, j11 1, j12 1, j13 1, j14 1, j15 1, j16 1 /
...
i14                           1     1                 1
;       
*     2   -20     2   -20     1    -2    -2     1    -2    -2    1    -2    -2     1    -2    -2
...
Variables          x(j) / j2.lo -20, j4.lo -20 /
...
$ echo jacobian singletonInequalityColumn_B0Bl0.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
