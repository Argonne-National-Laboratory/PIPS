* ./gamsexample.sh -NP=3 -BLOCKS=4 -GAMSFILE=./singletonInequalityColumn_B0Bl2 -PRESOLVE=true
...
parameter g(j) obj coefficients / j1 0, j2 1, j3 1, j4 1, j5 1, j6 1, j7 1, j8 1, j9 0, j10 1, j11 1, j12 1, j13 1, j14 1, j15 1, j16 1 /
...
*          clow(i) c left hand side    / i1 0, i2 1, i3 -1, i4 -100, i5 -100, i6 -100, i7 -100, i8 -100, i9 -100, i10 -100, i11 -100, i12 -100, i13 -100, i14 -100, i15 -100 /
          cupp(i) c right hand side   / i1 -1, i2 -1, i3 100, i4 100, i5 100, i6 100, i7 100, i8 100, i9 100, i10 100, i11 100, i12 100, i13 100, i14 -1, i15 -1 /
...
i14               1     1                 1
;       
*     2   -20     1    -2    -2     1    -2    -2     2   -20    1    -2    -2     1    -2    -2
...
Variables          x(j) / j2.lo -20, j10.lo -20, j10.up 20 /
...
$ echo jacobian singletonInequalityColumn_B0Bl2.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
