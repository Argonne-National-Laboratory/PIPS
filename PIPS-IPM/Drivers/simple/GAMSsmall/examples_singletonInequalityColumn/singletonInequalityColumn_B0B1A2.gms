* ./gamsexample.sh -NP=3 -BLOCKS=4 -GAMSFILE=./singletonInequalityColumn_B0B1A2 -PRESOLVE=true
...
*          clow(i) c left hand side    / i1 0, i2 1, i3 -1, i4 -100, i5 -100, i6 -100, i7 -100, i8 -100, i9 -100, i10 -100, i11 -100, i12 -100, i13 -100, i14 -100, i15 -100 /
          cupp(i) c right hand side   / i1 -1, i2 -1, i3 100, i4 100, i5 100, i6 100, i7 4, i8 0, i9 100, i10 100, i11 100, i12 100, i13 100, i14 -1, i15 -1 /
...
$ echo jacobian singletonInequalityColumn_B0B1A2.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
