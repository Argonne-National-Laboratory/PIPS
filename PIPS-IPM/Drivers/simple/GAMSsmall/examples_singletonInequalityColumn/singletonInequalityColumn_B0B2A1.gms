* ./gamsexample.sh -NP=3 -BLOCKS=4 -GAMSFILE=./singletonInequalityColumn_B0B2A1 -PRESOLVE=true
...
parameter g(j) obj coefficients / j1 0, j2 1, j3 0, j4 1, j5 1, j6 1, j7 1, j8 1, j9 1, j10 1, j11 0, j12 -1, j13 1, j14 1, j15 1, j16 1, j17 1, j18 1 /
...
*          clow(i) c left hand side    / i1 0, i2 1, i3 -1, i4 -100, i5 -100, i6 -100, i7 -100, i8 -100, i9 -100, i10 -100, i11 -100, i12 -100, i13 -100, i14 -100, i15 -100 /
          cupp(i) c right hand side   / i1 -1, i2 -1, i3 100, i4 100, i5 100, i6 100, i7 4, i8 0, i9 100, i10 100, i11 100, i12 100, i13 100, i14 100, i15 100 /
...
i14                           1     1                 1
;       
*     2   -20     2   -20     1    -2    -2     1    -2    -2          10     1    -2    -2     1    -2    -2
* expected values for x full determined by Ax=b

* the singletonInequalityRow i1/i14:
...
* i7:
* - 23 j12 - 3 j13 + 8 j14 = - 23 j12 -3 - 16 <= 4 <=> - 23 j12 <= 23 <=> j12 > 1 -> fix j12 at its known upper bound (10)
* i8:
* 4 j5 + 10 j11 + j14 - 3 j15 = 4 + 10 j11 - 2 + 6 <= 0 <=> 16 j11 <= -8 => in postsolve set j11 to -0.5
* we also have a fixing to do i2/i15:
* -0.5 j2 + j9 -3 j10 <= -1 -> in the final solution
* -0.5 j2 <= -5 <=> 5 < -0.5 j2 <=> -10 >= j2 -> fix j2 at its known lower bound (since the signums meet as well as it's objective direction)
Table C(i,j)
    j1    j2    j3    j4    j5    j6    j7    j8    j9   j10   j11   j12   j13   j14   j15   j16   j17   j18
i1       0.5                 1    -3
i2 -31                       1   -10   -20
...
Variables          x(j) / j2.lo -20, j4.lo -20, j11.up 20, j12.lo -10, j12.up 10 /
...
$ echo jacobian singletonInequalityColumn_B0B2A1.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
