...
parameter g(j) obj coefficients / j1 2, j2 2, j3 2, j4 2, j5 2, j6 2, j7 2, j8 2 /
          b(i) right hand side  / i1 3, i2 7, i3 2, i4 7, i5 7, i6 7 /
          cupp(i) right hand side  / i1 3, i2 9, i3 6, i4 7, i5 7, i6 8 /;
...
i4          5   0.4e-9     2
i5 0.4e-9   4                          3
i6 0.4e-10  1      1       1     1  0.4e-10  1     1
;
...
i4        5       0.4e-10
i5        4                      0.4e-9   0.4e-9
i6   1         1       1  0.4e-9 0.4e-10    1      1
;

Positive Variables x(j)  / j3.up 10, j7.up 5, j5.lo 0, j5.up 3 /;
...
$ echo jacobian exampleAC_tiny.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
