...
parameter g(j) obj coefficients / j1 1, j2 1, j3 1, j4 1, j5 1, j6 1, j7 1, j8 1, j9 1, j10 1, j11 1, j12 1, j13 1 /
          bA(i) right hand side  / i1 -2, i2 1, i3 -2, i4 0, i5 1, i6 -2, i7 0, i8 1, i9 -2, i10 0, i11 1, i12 -2, i13 0, i14 -10, i15 -1 /
...
$ echo jacobian parallelEqualityRows_B0A2.gdx > convertd.opt
  option lp=convertd;
  m.optfile = 1;
